...
│                     OrderBook Engine                         │
│  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐ │
│  │   Max Heap   │    │  Hash Map    │    │   Min Heap   │ │
│  │  (Buy Side)  │◄───┤ orders_map   │───►│ (Sell Side)  │ │
│  │   Bids       │    │   O(1) lookup│    │    Asks      │ │
│  │   Price ↓    │    └──────────────┘    │   Price ↑    │ │
│  └──────────────┘                        └──────────────┘ │
│         │                                        │         │
│         └────────────► Match Engine ◄────────────┘         │
                ...
                └─────────┬───────────┘
                  ...
                  └───┬────────┬───┘
                    Yes│      │No
                       │      │
         ┌─────────────▼      ▼──────────────┐
         │  Execute Trade     │ Leave in Book │
         │  Update Quantities │ Release Lock  │
         │  Log to WAL        │               │
         └────────────────────┴───────────────┘
```
...
│   │  │  • Matching Engine                        │  │        │
│   │  └───────────────────────────────────────────┘  │        │
│   │     ↑ Only ONE request at a time here ↑         │        │
│   └─────────────────────────────────────────────────┘        │
│                                                               │
│   Trade-off: Simple & Safe but serializes all operations     │
└──────────────────────────────────────────────────────────────┘
```
